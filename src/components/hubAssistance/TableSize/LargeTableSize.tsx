...
import HubAssistanceDetails from '../Dialog/InStockDetails'
...
const HubAssistanceTable = () => {
    ...
    const fetchData = useCallback(() => {
        dispatch(getStockFilter({ pageIndex, pageSize, sort, query, cylinderSize: '50kg' }))
                ...
                cell: (props) => {
                    ...
                    return (
                        <div className="flex items-center">
                            <Badge
                                className={stockStatusColor[status].dotClass}
                            />
                            <span
    ...
    return (
        ...
        <div className="lg:flex items-center justify-between mb-6">
                 <h4 className="flex gap-3 items-center text-sm mb-5"> <Link to='/hub-assistance'><FaArrowLeft/></Link>50kg Cylinders</h4>
        </div>
        <SizeTableSearch/>
            <DataTable
                ref={tableRef}
