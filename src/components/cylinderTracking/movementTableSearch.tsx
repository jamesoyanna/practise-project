...
const SizeTableSearch = () => {
    ...
    const tableData = useAppSelector((state) => state.StockList.data.tableData)

    const stockData = useAppSelector((state) => state.StockList.data.stockList)
    ...
    return (
        <div className="flex justify-center mb-8">
            <Input
                ...
                className=" "
                size="md"
                placeholder="Search by Holders Name"
