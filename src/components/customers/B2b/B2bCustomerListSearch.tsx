...
import {  
    setTableData,
    useAppDispatch,
    useAppSelector } from '../../../store/slices/customers/b2bCustomerSlice';
import debounce from 'lodash/debounce'
import cloneDeep from 'lodash/cloneDeep'
import type { TableQueries } from '@/@types/common'
import type { ChangeEvent } from 'react'

const B2bCustomerListSearch = () => {
...
export default B2bCustomerListSearch
function CustomerB2bList(data: TableQueries): any {
