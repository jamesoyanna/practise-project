...
const OnboardedSmartDeviceTable = () => {
    ...
    const columns: ColumnDef<Stock>[] = useMemo(
        () => [
            ...
            {
                header: 'Total Smart Devices Onboarded',
                accessorKey: 'deviceOnboarded',
            },
            { header: 'GSM', accessorKey: 'gsm' },
            { header: 'WIFI', accessorKey: 'wifi' },
        ],
        []
    )
        ...
        return (
            <div className="grid grid-rows-2 grid-flow-col pt-10">
                <div className="bg-gray-100 rounded-full py-5">
                    <span className="bg-red-600 p-2 rounded-full xs:rounded-lg font-bold text-base text-white text-sm">
                        Total No. of smart devices onboarded today:
                    </span>
    ...
    return (
        <>
            <div className="lg:flex items-left justify-between">
                <h4 className="flex gap-3 items-center text-sm ml-8 lg:mb-0">
                    {' '}
                    <Link to="/smart-devices-onboarded">
                        <FaArrowLeft />
                    </Link>{' '}
                    Smart Devices Onboarded
                </h4>
            </div>
...
export default OnboardedSmartDeviceTable
