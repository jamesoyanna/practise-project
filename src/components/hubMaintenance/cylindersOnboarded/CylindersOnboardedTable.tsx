...
import HubAssistanceDetails from '../../hubMaintenance/Dialog/CylindersOnboardedDetails'
...
const CylindersOnboardedTable = () => {
    ...
    const columns: ColumnDef<Stock>[] = useMemo(
        () => [
            { header: 'Cylinder ID', accessorKey: 'cylinderId' },
            { header: 'Cylinder Type', accessorKey: 'cylinderType' },
            { header: 'Cylinder Size', accessorKey: 'cylinderSize' },
            {
...
export default CylindersOnboardedTable
